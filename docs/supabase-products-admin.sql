...
values
  (
    ...
    '200ml',
    24,
    '/images/offers/fly-campaign.jpeg',
    null,
    'quote',
    false,
  ...
  (
    ...
    'Special Nova 330ml offer: buy 15 cartons and get 5 cartons free, with free delivery in Riyadh for SAR 350 only.',
    'عرض مميز على مياه نوفا 330 مل: اشتر 15 كرتون واحصل على 5 كراتين مجانا، شامل التوصيل المجاني داخل الرياض بسعر 350 ريال فقط.',
    true,
    true,
    0,
    'offer',
  ...
  (
    ...
    'Fly Water',
    'فلاي',
    'Fly Water 15 + 5 Cartons Offer',
    'عرض مياه فلاي 15 + 5 كراتين',
    'offer',
    '200ml',
    '200ml / 330ml',
    20,
    ...
    true,
    null,
    'Buy 15 Fly Water cartons and get 5 cartons free. Available in 200ml x48 bottles or 330ml x40 bottles for SAR 195 including VAT and delivery in Riyadh.',
    'اشتر 15 كرتون مياه فلاي واحصل على 5 كراتين مجانا. متوفر 200 مل 48 عبوة أو 330 مل 40 عبوة بسعر 195 ريال شامل الضريبة والتوصيل داخل الرياض.',
    true,
    true,
    1,
    'offer',
